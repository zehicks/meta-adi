...
SRC_URI:append = " \
		...
		file://zynq-pluto-sdr-base.dtsi \
		file://zynq-pluto-sdr-revb-base.dtsi \
		file://zynq-pluto-sdr-revb-base.dts \
		file://pl-zynq-pluto-sdr-revb-overlay.dtsi \
		file://pl-zynq-pluto-sdr-overlay.dtsi"
...
do_configure:append() {
	...
	if grep -qse "/plugin/;" "${DT_FILES_PATH}/pl.dtsi"; then
		cp "${WORKDIR}/${DTS_BASE}.dts" "${DT_FILES_PATH}/system-top.dts"
